                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(TransitionChild), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="fixed inset-0 bg-black bg-opacity-25" data-v-13f271d9${_scopeId3}></div>`);
                      } else {
                        return [
                  ...
                  _push3(`<div class="fixed inset-0 overflow-y-auto" data-v-13f271d9${_scopeId2}><div class="flex min-h-full items-center justify-center p-4 text-center" data-v-13f271d9${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(TransitionChild), {
                    as: "template",
                    enter: "duration-300 ease-out",
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(DialogPanel), { class: "model w-full max-w-md md:max-w-xl lg:h-auto transform overflow-hidden rounded-2xl bg-primary text-left align-middle shadow-xl transition-all text-gray-100 font-bold font-montserrat py-6 px-4 md:p-8 relative" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<button class="material-symbols-outlined absolute right-4 top-4/5" data-v-13f271d9${_scopeId4}> close </button>`);
                              ...
                              _push5(`<div class="mt-2" data-v-13f271d9${_scopeId4}><p class="para text-sm leading-snug sm:w-4/4 sm:my-6" data-v-13f271d9${_scopeId4}> Thanks for stopping by! Want to make a positive impact in the world? Consider volunteering with us! </p></div><div class="mt-4 text-end" data-v-13f271d9${_scopeId4}><button type="button" class="orange-btn shadow-lg rounded-md text-sm sm:text-lg py-3 sm:px-6" data-v-13f271d9${_scopeId4}> Take Action Now </button></div>`);
                            } else {
                              return [
                                createVNode("button", {
                                  onClick: closeModal,
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-13f271d9"]]);
...
//# sourceMappingURL=default-83c93ed3.mjs.map
